      ...
      <header className='fixed top-0 left-0 z-50 w-screen h-[8vh] md:shadow-md shadow-sm bg-white '>
         ...
         <div className='hidden md:flex justify-between px-7 p-2'>
            ...
            <div className='logo flex'>
               ...
               <h2 className='text-2xl font-semibold ml-3'>Tune</h2>
            </div>
            ...
            <div className='profile flex items-center'>
               <AiOutlineSearch size={22} className="text-primary AiOutlineSearchHeader" />
               <button className='bg-primary px-6 py-1.5 text-white rounded-full mx-3 uploadBtn'>
                  Upload
               </button>
         ...
         <div className="float-right right-6 relative text-primary bg-gray-400 h-auto w-84">asdf</div>
      </header>
   );
};
